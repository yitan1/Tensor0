"""Two-device Dot contracts in isolated processes."""
...
@pytest.mark.parametrize('operation,mode', [('dot', 'auto'), ('dot', 'explicit'), ('dot', 'left_storage'), ('dot', 'right_storage')])
def test_distributed_dot(operation, mode):
