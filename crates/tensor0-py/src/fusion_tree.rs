...
impl PyFusionTree {
    ...
    fn uncoupled(&self, py: Python<'_>) -> PyResult<Py<PyAny>> {
        match &self.inner {
            ...
            FusionTreeInner::FermionParityU1SU2Irrep(tree) => sectors_tuple_py(py, &tree.uncoupled),
        }
    }
